...
console.log(`1번 문제 정답: ${student.name}의 점수는 ${subject.kor}, ${subject.math}, ${subject.eng}, ${subject.science}입니다`)
...
student.subject = 85
console.log(`2번 문제 정답: ${student.subject}점`)
...
console.log(student.substring(reault))

console.log(`4번 문제 정답: ${reault}`)
...
const addr = employees.filter((employees) => {
   if (employees.indexOf('서울시') === -1) {
      return false
